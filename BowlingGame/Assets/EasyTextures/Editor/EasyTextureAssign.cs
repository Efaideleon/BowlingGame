namespace EasyTextureAssign
{
    ...
    public class EasyTextureAssign
    {
        ...
        private static Texture albedo, metallic, emission, normal, height, occlusion, mask = null;
        #endregion
        ...
        private static void CreateMatFromTexture()
        {
            ...
            if (EditorUtility.DisplayDialog("Create NEW Material?", "Create new material from selection?\n\nYou cannot undo this action.", "Create", "Cancel"))
            {
                ...
                else if (mask != null) fileName = mask.name;
        ...
        private static void FindTextures(Object[] objects)
        {
            ...
            mat = null;
            foundTextures = false;
            albedo = metallic = emission = normal = height = occlusion = mask = null;
            ...
            foreach (Object obj in allObjects)
            {
                ...
                else if (obj is Texture)
                {
                    ...
                    else if (texture.name.ToLower().Contains(ETSettings.maskName.ToLower()) && mask == null)
                    {
                        mask = texture;
                        foundTextures = true;
                    }
        ...
        private static void AssignTextures(bool undo = true)
        {
            ...
            if (mask != null) { message += "  " + mask.name + "\n"; }
        ...
        private static void DoClear(List<Material> mats)
        {
            ...
            foreach (var selectedMat in mats)
            {
                ...
                selectedMat.SetTexture("_BaseColorMap", null);
    ...
    public class ETSettings : EditorWindow
    {
        ...
        public static string maskName = "mask";
        ...
        private void OnGUI()
        {
            ...
            // mask
            if (EditorPrefs.HasKey("Mask Unique Name"))
                maskName = EditorPrefs.GetString("Mask Unique Name");
            else
                EditorPrefs.SetString("Mask Unique Name", maskName);
            maskName = EditorGUILayout.TextField(new GUIContent("Mask", textFieldTooltip), maskName, GUILayout.MaxWidth(300));
            EditorPrefs.SetString("Mask Unique Name", maskName);
